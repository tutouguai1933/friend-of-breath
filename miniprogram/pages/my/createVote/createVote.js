Page({
  data: {
    ...
    votepack: {
      ...
      image: "../../../images/pic_160.png", //默认logo
      startTime:"",
    }
  },
  //设置匿名
  ...
  set_content: function (e) {
    ...
    content = this.fliteremoji(content);
    this.setData({
  ...
  saveVote2: function () {
    ...
    if (errormsg != "格式错误:") {
      ...
      // wx.request({
      //   method: "GET",
      //   url: this.globalData.host+'/wx_graduation_voteforyou/',
      //   data: { "scene":"wx_vote_save","userid": this.globalData.userid,"votepack":votepack},
        ...
        .then(res => {
          ...
          wx.showModal({
            ...
            complete: function () {
              //跳转投票详情页
              wx.navigateTo({
                url: '../..//home/voteSystem/voteSystem',
              })
            }
          })
        })
  ...
  chooseImage: function (e) {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        // 上传
        wx.uploadFile({
          url: "this.globalData.host" + '/wx_graduation_voteforyou/', //仅为示例，非真实的接口地址
          ...
          success: function (res) {
            ...
            //do something
            that.setData({
              'votepack.image': this.globalData.host + data,
            })
            wx.hideLoading();
          },
          fail: function () {
